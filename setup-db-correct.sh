#!/bin/bash
# Setup database tables with correct credentials
# User: realestate, Database: realestate_db
...
docker exec -i real-estate-os-db-1 psql -U realestate -d realestate_db << 'EOF'
...
echo "Visit the frontend or API to start using the platform."
echo ""
